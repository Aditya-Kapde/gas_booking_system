...
const Address = () => {
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        // Here you would typically send both addressData and bookingDetails to your backend
        console.log('Submitting order:', { addressData, bookingDetails });
        // For now, just show a success message
        alert('Proceeding to payment...');
        navigate('/payment', { state: { bookingDetails, addressData } });
    };
